...
class pop3_class
{
	...
	Function OpenConnection()
	{
		...
		if(($this->connection=@fsockopen(($this->tls ? "tls://" : "").$this->hostname,$this->port,$error, $errstr))==0)
		{
			switch($error)
			{
				case -3:
				...
				default:
					return($this->SetError($error." could not connect to the host (" . $errstr . ") \"".$this->hostname."\""));
			}
		}
		return("");
	}
